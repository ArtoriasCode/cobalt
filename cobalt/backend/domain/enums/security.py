...
class PermissionEnum(StrEnum):
    ...
    SERVER_FILES_CREATE = "server_files_create"
    SERVER_FILES_UPDATE = "server_files_update"
    SERVER_FILES_DELETE = "server_files_delete"
    SERVER_FILES_UPLOAD = "server_files_upload"
    SERVER_FILES_DOWNLOAD = "server_files_download"
    SERVER_FILES_EXTRACT = "server_files_extract"
